...
import { loginDoorFromHash, isTillKiosk, isClockKiosk, isLiveKiosk, isMakeKiosk, doorAllowsRole, hashForDoor, LOGIN_DOORS } from '../src/lib/barDoors.js'
...
assert('caixa drinks board is not till', isMakeKiosk('caixa', 'make') && !isTillKiosk('caixa', 'make'))
